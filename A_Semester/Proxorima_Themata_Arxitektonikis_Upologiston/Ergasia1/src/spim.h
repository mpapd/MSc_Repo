...
extern int cache_simulation; //Nel
extern int data_simulation;
extern int inst_simulation;

extern unsigned int cache_bytesize;
extern unsigned int cache_block_bytesize;
extern unsigned int cache_ways;
extern unsigned int cache_wrHit;
extern unsigned int cache_wrMiss;
extern unsigned int cache_algorithm;
extern int show_rate;
extern unsigned int cache_instbytesize;
extern unsigned int cache_instblock_bytesize;
extern unsigned int cache_instways;
extern unsigned int cache_instalgorithm;
extern int show_rateI;
