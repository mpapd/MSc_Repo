...
int cache_simulation; //Nel To activate simulation
int data_simulation;
int inst_simulation;  
unsigned int cache_bytesize;
unsigned int cache_block_bytesize;
unsigned int cache_ways;
unsigned int cache_wrHit;
unsigned int cache_wrMiss;
unsigned int cache_algorithm;
int show_rate;
unsigned int cache_instbytesize;
unsigned int cache_instblock_bytesize;
unsigned int cache_instways;
unsigned int cache_instalgorithm;
int show_rateI;
